<?php
    ...
    try {
        ...
        $query = "INSERT INTO news (`title`, `article`, `image_filepath`, `date`) VALUES (?, ?, ?, ?)";
        ...
        $insertArticle->bindParam(3, $image_filepath, PDO::PARAM_STR);
        $insertArticle->bindParam(4, $date, PDO::PARAM_STR);
